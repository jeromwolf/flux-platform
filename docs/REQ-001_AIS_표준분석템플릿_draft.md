...
| (Vessel)-[:TRANSMITTED_BY]->(VHFMessage) | 교신 발신 | KRISO 선행연구(표 II-7) |

> ※ TRANSMITTED_BY·PORT_ENTRY·BERTH_TO 등 해사 특화 관계는 KRISO 선행연구(오재용·김혜진 2024)의 관계 유형을 DES-001 온톨로지 설계에 반영한다.
