...
### 1.2 대상 — 10종
- **핵심 8종** (정성제안서 표 II-6, 선행연구 기반): AIS · GPS · 항해장비 · RADAR · VHF · Port-MIS · CCTV · 환경정보
- **확장 2종** (과업지시서 추가 언급): 전자해도(ENC) · 법령
...
| **환경정보** | WeatherObservation·Area·ObservationStation | OBSERVED_AT·AFFECTS(→Voyage) | 기상-항행 영향, 사고 원인 분석 |
...
- **탐지·관측**: DETECTED · MATCHED_WITH · OBSERVED_AT · MEASURED_BY
